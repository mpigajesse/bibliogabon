...
import { ClipboardList, Layers3, GraduationCap, Globe2 } from "lucide-react";
...
export const Route = createFileRoute("/examens")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Annales d'examens des universités gabonaises avec corrigés détaillés.",
      },
      { property: "og:title", content: "Examens — BiblioGabon" },
      {
        property: "og:description",
        content: "Annales et sujets d'examens universitaires du Gabon.",
      },
    ],
  }),
...
function ExamensPage() {
  const docs = documentsByType("examen");
  ...
  return (
    <SiteLayout>
      ...
      <CatalogueStatsStrip
        stats={[
          { icon: ClipboardList, value: docs.length, label: "Épreuves archivées" },
      ...
      <section>
        <div className="container-editorial py-12">
          <CatalogueBrowser documents={docs} lockedType="examen" />
        </div>
      </section>
    </SiteLayout>
  );
